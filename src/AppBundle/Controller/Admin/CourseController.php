...
class CourseController extends Controller
{
    ...
    public function newAction(Request $request)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('admin_courses_show', array('id' => $course->getId()));
        }

        return $this->render('admin/course/new.html.twig', array(
            'course' => $course,
     ...
     *
     * @Route("/{id}", name="admin_courses_show")
     * @Method("GET")
     */
    public function showAction(Course $course)
    {
        ...
        return $this->render('admin/course/show.html.twig', array(
            'course' => $course,
    ...
    public function editAction(Request $request, Course $course)
    {
        ...
        if ($editForm->isSubmitted() && $editForm->isValid()) {
            ...
            return $this->redirectToRoute('admin_courses_edit', array('id' => $course->getId()));
        }
     ...
     *
     * @Route("/{id}", name="admin_courses_delete")
     * @Method("DELETE")
     */
    ...
    private function createDeleteForm(Course $course)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_courses_delete', array('id' => $course->getId())))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
